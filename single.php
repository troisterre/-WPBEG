			...
			<div class="c-grid">
				<div class="p-contents">
					<div class="p-post">
						...
						<h2 class="p-post__ttl"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
						<ul class="post__meta">
			      ...
			      <ul class="p-pagenation">
							<?php if(get_previous_post()): ?>
								<li class="prevpostslink"><?php previous_posts_link('%link','Prev'); ?>
								<?php endif; ?>
								<?php if(get_next_post()): ?>
								<li class="prevpostslink"><?php next_posts_link('%link','Next'); ?>
								<?php endif; ?>
								</ul>
								<?php endif; ?>
						<?php endwhile; 
